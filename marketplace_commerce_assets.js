...
for(const name of ['marketplace_commerce.css','marketplace_commerce_ui.js','marketplace_impulse_home.js','marketplace_commerce_admin_ui.js']){
...
if(fs.existsSync(idx)){
  ...
  html=html.replace('</head>','<link rel="stylesheet" href="/marketplace_commerce.css?v=20260917-1">\n</head>');
