...
for(const name of ['marketplace_commerce.css','marketplace_commerce_ui.js','marketplace_impulse_home.js','marketplace_commerce_admin_ui.js','marketplace_payments_ui.js']){
...
if(fs.existsSync(idx)){
  ...
  html=html.replace('</head>','<link rel="stylesheet" href="/marketplace_commerce.css?v=20260917-2">\n</head>');
  html=html.replace('</body>','<script src="/marketplace_commerce_ui.js?v=20260917-2"></script>\n<script src="/marketplace_impulse_home.js?v=20260917-1"></script>\n<script src="/marketplace_commerce_admin_ui.js?v=20260917-1"></script>\n<script src="/marketplace_payments_ui.js?v=20260917-1"></script>\n</body>');
