...
for(const name of ['local_market_home.css','local_market_home.js','local_market_home_guard.js']){
...
if(fs.existsSync(idx)){
  ...
  html=html.replace(/src="\/datoya-logo\.jpg[^\"]*"/g,'src="/brand/datoya-logo-horizontal.png?v=20260917-2"');
  ...
  html=html.replace('</head>','<link rel="stylesheet" href="/local_market_home.css?v=20260917-2">\n</head>');
  html=html.replace('</body>','<script src="/local_market_home.js?v=20260917-2"></script>\n<script src="/local_market_home_guard.js?v=20260917-2"></script>\n</body>');
