...
h=h.replace('</head>','<link rel="stylesheet" href="/marketplace_admin_v2.css?v=20260923-4">\n</head>');
h=h.replace('</body>','<script src="/marketplace_admin_v2_ui.js?v=20260923-2"></script>\n</body>');
