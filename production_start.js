...
try{
 ...
 require('./mercadopago_source_bootstrap');require('./mercadopago_fee_policy_bootstrap');require('./hybrid_payment_bootstrap');require('./account_security_bootstrap');require('./account_security_route_fix');require('./admin_pro_gift_bootstrap');require('./meeting_verification_bootstrap');require('./job_trust_center_bootstrap');require('./job_mutual_completion_guard');require('./worker_specialties_bootstrap');require('./worker_portfolio_bootstrap');require('./chile_security_bootstrap');require('./territory_start');
 require('./mercadopago_assets');require('./account_security_assets');require('./admin_pro_gift_assets');require('./meeting_verification_assets');require('./job_trust_center_assets');require('./job_detail_assets');require('./admin_command_center_assets');require('./worker_profile_polish_assets');require('./home_search_polish_assets');require('./onboarding_flow_assets');require('./admin_navigation_polish_assets');require('./worker_specialties_assets');require('./admin_security_assets');require('./phone_security_assets');require('./worker_portfolio_assets');
