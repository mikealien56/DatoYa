...
h=h.replace('</head>','<link rel="stylesheet" href="/business_impulse_plan.css?v=20260922-2">\n</head>');
h=h.replace('</body>','<script src="/business_impulse_plan_ui.js?v=20260922-2"></script>\n</body>');
