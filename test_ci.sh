...
grep -q "modeInfo.mode==='test'?(mp.sandbox_init_point||mp.init_point):(mp.init_point||mp.sandbox_init_point)" marketplace_payments_bootstrap.js || { echo "Checkout Pro no separa URL sandbox y live"; exit 1; }
