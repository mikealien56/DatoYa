...
(function(){
 ...
 routes.admin=async function(tab='dashboard'){
  ...
  view.innerHTML='<h2 class="section-title" style="margin-top:0">🛡️ Centro de operaciones</h2><p class="small muted">Lo que necesita atención y el estado general de DatoYa en una sola vista.</p>'+
   ...
   '<div class="card"><h3 style="margin-top:0">Accesos rápidos</h3><div class="row" style="gap:7px;flex-wrap:wrap"><a class="btn btn-outline btn-sm" href="#/admin/trabajos">🧾 Trabajos</a><a class="btn btn-outline btn-sm" href="#/admin/usuarios">👥 Usuarios</a><a class="btn btn-outline btn-sm" href="#/admin/trabajadores">🔧 Profesionales</a><a class="btn btn-outline btn-sm" href="#/admin/suscripciones">⭐ PRO</a><a class="btn btn-outline btn-sm" href="#/admin/regalar-pro">🎁 Regalar PRO</a><a class="btn btn-outline btn-sm" href="#/admin/auditoria">🕘 Auditoría</a></div></div>'+
