...
if(fs.existsSync(idx)){
 ...
 if(!h.includes('/worker_specialties_ui.js')) h=h.replace('</body>','<script src="/worker_specialties_ui.js?v=1"></script>\n</body>');
 else h=h.replace(/\/worker_specialties_ui\.js(?:\?v=\d+)?/g,'/worker_specialties_ui.js?v=1');
