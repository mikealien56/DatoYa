...
if(fs.existsSync(idx)){let h=fs.readFileSync(idx,'utf8');h=h.replace(/<script src="\/admin_support_cases_ui\.js(?:\?v=[^"]*)?"><\/script>\s*/g,'');h=h.replace('</body>','<script src="/admin_support_cases_ui.js?v=20260921-1"></script>\n</body>');fs.writeFileSync(idx,h);}
