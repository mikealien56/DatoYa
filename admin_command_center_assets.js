...
if(fs.existsSync(idx)){
 ...
 if(!h.includes('/admin_command_center_ui.js'))h=h.replace('</body>','<script src="/admin_command_center_ui.js?v=3"></script>\n</body>');
 else h=h.replace(/\/admin_command_center_ui\.js(?:\?v=\d+)?/g,'/admin_command_center_ui.js?v=3');
