...
if(fs.existsSync(idx)){
  ...
  html=html.replace('</head>','<link rel="stylesheet" href="/marketplace_business.css?v=20260924-2">\n<link rel="stylesheet" href="/marketplace_public_beta.css?v=20260924-2">\n</head>');
  html=html.replace('</body>','<script src="/marketplace_business_ui.js?v=20260924-2"></script>\n<script src="/marketplace_business_admin_ui.js?v=20260917-2"></script>\n<script src="/marketplace_public_beta_ui.js?v=20260924-2"></script>\n</body>');
