/* DatoYa — directed request category lock */
(() => {
  ...
  function note() {
    return `<div class="lock-note" style="margin-bottom:14px">👷 <b>Profesional seleccionado:</b> ${esc(wiz.targetWorker.name)}<br>🛠️ <b>Especialidad:</b> ${esc(wiz.catName)}<br><span class="small muted">La especialidad está fijada al perfil del profesional.</span></div>`;
  }
