...
grep -q "source_type,'impulse_now'" beta_private_features_bootstrap.js || { echo "DatoYa Alerta no considera Impulso Ahora"; exit 1; }
grep -q "source_type,'weekly'" beta_private_features_bootstrap.js || { echo "DatoYa Alerta no considera Impulso semanal"; exit 1; }
